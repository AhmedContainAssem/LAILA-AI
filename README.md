<div align="center">
  ...
  <img src="docs/diagrams/hero-banner.svg" alt="LAILA AI Hero Banner" width="100%" />
  ...
  <p align="left"><b>🌐 00. Native Workstation Welcome Hub & Quick Navigation Guide</b></p>
  <img src="docs/screenshots/welcome-workspace-hub.png" alt="Native Workstation Welcome Hub" width="100%" style="border-radius: 12px; border: 1.5px solid #1E293B;" />
  ...
  <table width="100%">
    <tr>
      <td width="50%" align="center" valign="top">
        <p align="left"><b>📝 05. Notebook Studio (Direct Canvas AI Drafting, Smart Checklists & Markdown)</b></p>
        <img src="docs/screenshots/notebook-editor-workspace.png" alt="Notebook Editor & AI Panel" width="100%" style="border-radius: 10px; border: 1px solid #1E293B;" />
      </td>
      <td width="50%" align="center" valign="top">
        <p align="left"><b>📑 06. Document Engine Exports (PDF, Word DOCX, Markdown, CSV)</b></p>
        <img src="docs/screenshots/notebook-export-methods.png" alt="Multi-Format Export Menu" width="100%" style="border-radius: 10px; border: 1px solid #1E293B;" />
      </td>
    </tr>
  </table>
  ...
  <table width="100%">
    <tr>
      <td width="50%" align="center" valign="top">
        <p align="left"><b>🔐 07. AI Providers Matrix (Windows DPAPI Hardware Encryption)</b></p>
  ...
  <table width="100%">
    <tr>
      <td width="50%" align="center" valign="top">
        <p align="left"><b>📖 09. Pilots Command Hub & Action Catalog</b></p>
        <img src="docs/screenshots/pilots-guide-hub.png" alt="Pilots Command Hub" width="100%" style="border-radius: 10px; border: 1px solid #1E293B;" />
      </td>
      <td width="50%" align="center" valign="top">
        <p align="left"><b>👤 10. User Profile & Persona Customization Modal</b></p>
        <img src="docs/screenshots/profile-customization-modal.png" alt="Profile Customization Modal" width="100%" style="border-radius: 10px; border: 1px solid #1E293B;" />
      </td>
    </tr>
  </table>
